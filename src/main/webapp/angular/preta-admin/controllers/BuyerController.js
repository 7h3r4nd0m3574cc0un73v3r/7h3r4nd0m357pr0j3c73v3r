...
App.controller( 'BuyerController', [ '$filter', '$state', '$stateParams', '$scope', '$uibModal', 'UserService',
                                     function( $filter, $state, $stateParams, $scope, $uibModal, UserService)
{
	/* Loading Mutexes */
	...
	if( $stateParams.id != undefined) {
		loadEntity( $stateParams.id);
	}
	
	function loadEntity( id) {
		$scope.isEntityLoading = true;
		UserService.loadEntity( id)
				   .then( function( r) {
					   $scope.entity = r;
